...
impl Line {
    fn power_loss_kw(&self, power_kw: f64, voltage_kv: f64) -> f64 {
...
impl Transformer {
    fn refer_to_primary(&self, power_kw: f64) -> f64 {
        if power_kw >= 0.0 {
...
impl Bus {
    ...
    fn try_night_grid_charge(&mut self, hour: usize) -> f64 {
    ...
    fn try_discharge(&mut self, deficit_kw: f64) -> (f64, f64) {
